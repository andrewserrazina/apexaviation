-- Apex Advantage — Apex Operations scheduling foundation (v19)
-- Adds the first internal Operations data model with RLS enforced for
-- instructors/admins. Students are intentionally excluded from Operations data.
...
create index operations_events_date_idx
  on public.operations_events (event_date, start_time);

create index operations_events_instructor_idx
